        ...
        <div className="lg:max-w-5xl md:max-w-3xl max-w-sm mx-auto">
            <div className="bg-lime-50/50 shadow-md mt-40">
                <form method="post" onSubmit={submitEvent} className="p-[2%]">
                    <p className="text-sm font-bold pb-2">닉네임</p><input type="text" name="name" defaultValue={session?.user.name ?? ''} onChange={changeEvent} className="shadow text-gray-700 text-sm mb-2 block p-1.5 border-l-2 border-lime-600" /><br />
