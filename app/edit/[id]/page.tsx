            ...
            <div className="lg:max-w-5xl md:max-w-3xl max-w-sm mx-auto">
                <div className="bg-white shadow-md mt-40">
                    <form method="post" onSubmit={submitEvent} className="p-[2%]">
                        <p className="text-sm font-bold">닉네임</p><input type="text" name="name" defaultValue={formData.title} onChange={changeEvent} className="shadow text-gray-700 text-sm mb-2 border block p-1.5" /><br />
